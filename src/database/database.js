...
class DB {
  ...
  async initializeDatabase() {
    try {
      ...
      console.error(JSON.stringify({ message: 'Error initializing database', exception: err.message, connection: { host: config.db.connection.host, database: config.db.connection.database } }));
    }
  }
